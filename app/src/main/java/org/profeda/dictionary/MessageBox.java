    ...
    public static void showChangeLog(Context context) {
        ...
        new AlertDialog.Builder(ctx)
                ...
                .setMessage(Html.fromHtml(
                        "<p>Version 2014-08\n</p>" +
                                "<p> Changed name</p>" +
                                "<p> Added automatic loading of dictionary</p>" +
                                ...
                                "</ul>\n\n<p><b>Thank you for using this app! I appreciate your feedback via E-Mail (android@profeda.org) and Facebook (see Menu).</b></p>"))
